...
class FoosControllerTest < ActionController::TestCase
  ...
  test "should create foo" do
    assert_difference('Foo.count') do
      post :create, foo: { date: @foo.date, float_number: @foo.float_number, int_number: @foo.int_number, name: @foo.name }
    end
  ...
  test "should update foo" do
    patch :update, id: @foo, foo: { date: @foo.date, float_number: @foo.float_number, int_number: @foo.int_number, name: @foo.name }
    assert_redirected_to foo_path(assigns(:foo))
  end
